...
function AccountOperations() {
  ...
  function handleDeposit() {
    ...
    dispatch(deposit(depositAmount)); //here we dispatch out action which is the (deposit)  coming from the account slice and dont forget to import it to out reducer
    setDepositAmount("");
    setCurrency("USD");
  }
